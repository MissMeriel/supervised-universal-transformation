...
for transf in ${transfs[@]}; do 
    python train_baseline2.py --effect  $transf -d "270 480" --pretrained_model $pretrainedmodel --RRL_dir /p/sdbb/supervised-transformation-dataset-alltransforms3/ --epochs 5000 --lr 0.0001  -o $SLURM_JOB_ID 
done