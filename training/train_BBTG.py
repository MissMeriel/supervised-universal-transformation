...
## Logging
    log_dir, index_suffix = create_logdir("Kingma",args.dataset, args.latent_dim, args.index)
    ...
    vae = KingmaVAE(args.model, input_suffix, channels, args.latent_dim).to(device)
